  ...
  return (
    <div>
      <section className="min-h-dvh">
        <div className="mx-auto flex max-w-6xl flex-col justify-center gap-5 px-4 pt-28 md:flex-row-reverse md:items-start">
          {/* Left */}
          <div className="relative h-96 w-full md:max-w-1/2">
            ...
            <div className="absolute -right-1 -bottom-16 aspect-square w-1/2 md:-right-8">
              <img
          ...
          <div className="mt-16 ml-0 w-full text-black md:mt-0 md:ml-10 md:max-w-1/2">
            ...
            <p className="mb-8 pr-2 text-lg leading-relaxed md:text-pretty">
...
const ServiceCard = ({ icon, title, description }) => {
  return (
    <div className="flex max-w-xl flex-col items-start gap-4 p-4 md:flex-row">
      <div className="flex-shrink-0">{icon}</div>
      <span className="hidden h-36 border-l md:block" />
      <div>
        <h3 className="mb-2 text-2xl md:text-xl">{title}</h3>
